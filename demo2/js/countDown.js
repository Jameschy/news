...
(function (global, factory) {
    ...
    var ___=window;
    //模板
    var $defaultTitle=["","","Only Have"];
    var $template="<span class=\"active-time\"><t class='time_prefix'></t></span><br/><span><i class=\"time_d\"></i>D<i class=\"time_h\"></i><sub>H</sub><i class=\"time_m\"></i><sub>M</sub><i class=\"time_s\"></i><t class='time_suffix'><sub>S</sub></span>";
